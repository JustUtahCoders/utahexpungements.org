...
export default class PositionedCheckmark extends React.Component {
  static eitherShouldShowOrDataKey(props, propName, componentName) {
    if (typeof props.shouldShow !== 'boolean' && typeof props.dataKey !== 'string') {
      return Error(`A ${componentName} was rendered without either a 'shouldShow' boolean prop or a 'dataKey' string prop. One of the two is required. Props passed were '${JSON.stringify(props)}'`)
    }
  }
  static propTypes = {
